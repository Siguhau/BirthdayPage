...
const WelcomeText: React.FC<WelcomeTextProps> = ({ userName, isBirthday }) => {
  ...
  useEffect(() => {
    ...
    if (isBirthday) {
      ...
      const confettiArray = Array.from(
        { length: getConfettiCount() },
        (_, i) => i + Math.random() * 100000,
      );
  ...
  return (
    ...
    >
          ...
          <div
            ...
            style={{
              ...
              backgroundColor: [
                ...
                "#c44569",
                "#786fa6",
              ][Math.floor((particle * 17 + particle * 23) % 15)],
              borderRadius: "50%",
      ...
      {isBirthday ? (
        ...
        <h2>Tid til {userName}'s bursdag</h2>
      )}
    </div>
  );
};
